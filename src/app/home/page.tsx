...
const Home = () => {
  return (
    ...
    <div className="font-sans">
      <div className="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-[#FFA726] mt-8">
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-6 px-4 my-12">
        <div className="bg-gray-100 p-6 rounded-md">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#FFA726" className="w-10 h-10 mb-4 inline-block bg-white p-2 rounded-md" viewBox="0 0 32 32">
          ...
          <a href="#" className="text-[black]  font-bold inline-block text-sm mt-4 hover:underline">Learn more</a>
        </div>
        <div className="bg-gray-100 p-6 rounded-md">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#FFA726" className="w-10 h-10 mb-4 inline-block bg-white p-2 rounded-md" viewBox="0 0 512.001 512.001">
        ...
        <div className="bg-gray-100 p-6 rounded-md">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#FFA726" className="w-10 h-10 mb-4 inline-block bg-white p-2 rounded-md" viewBox="0 0 24 24">
        ...
        <div className="bg-gray-100 p-6 rounded-md">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#FFA726" className="w-10 h-10 mb-4 inline-block bg-white p-2 rounded-md" viewBox="0 0 682.667 682.667">
            <defs>
              <clipPath id="a" clipPathUnits="userSpaceOnUse">
                <path d="M0 512h512V0H0Z" data-original="#000000" />
              </clipPath>
            </defs>
            <g fill="none" stroke="#FFA726" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="40" clipPath="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
      ...
      <div className="lg:max-w-7xl max-w-lg mx-auto px-6 py-8 bg-white rounded-lg shadow-md">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            <h2 className="text-3xl font-extrabold text-[#FFA726] mb-4">Immerse Yourself in Creativity</h2>
            ...
            <div className="mt-6">
              <a href="#" className="text-[#FFA726] text-sm font-semibold hover:underline">Get Started</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="bg-gray-50 px-4 py-10 font-[sans-serif]">
      <h2 className="text-gray-800 text-3xl font-bold mb-14 text-center">Software Metrics</h2>
      <div className="grid sm:grid-cols-2 gap-6 max-w-6xl mx-auto">
        <div className="bg-white flex gap-6 max-lg:flex-col rounded-2xl md:p-8 p-6 shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.2)]">
          <h3 className="text-gray-800 text-5xl font-extrabold">5.4<span className="text-[#FFA726]">M+</span></h3>
          <div>
            <p className="text-gray-800 text-base font-bold">Total Users</p>
        ...
        <div className="bg-white flex gap-6 max-lg:flex-col rounded-2xl md:p-8 p-6 shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.2)]">
          <h3 className="text-gray-800 text-5xl font-extrabold">$80<span className="text-[#FFA726]">K</span></h3>
          <div>
        ...
        <div className="bg-white flex gap-6 max-lg:flex-col rounded-2xl md:p-8 p-6 shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.2)]">
          <h3 className="text-gray-800 text-5xl font-extrabold">100<span className="text-[#FFA726]">K</span></h3>
          <div>
        ...
        <div className="bg-white flex gap-6 max-lg:flex-col rounded-2xl md:p-8 p-6 shadow-[0_-4px_24px_-8px_rgba(0,0,0,0.2)]">
          <h3 className="text-gray-800 text-5xl font-extrabold">99.9<span className="text-[#FFA726]">%</span></h3>
          <div>
            <p className="text-gray-800 text-base font-bold">Server Uptime</p>
            <p className="text-sm text-gray-500 mt-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis accumsan, nunc et tempus blandit, metus mi consectetur felis turpis vitae ligula.</p>
          </div>
        </div>
      </div>
