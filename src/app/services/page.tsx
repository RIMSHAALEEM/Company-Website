...
const Services = () => {
  return (
    <div className="max-w-6xl mx-auto font-[sans-serif] mt-12 mb-16">
    ...
    <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
      <div className="text-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="#FFA726" className="w-8 mb-6 inline-block" viewBox="0 0 32 32">
        ...
        <p className="text-gray-600 text-sm">Tailor our product to suit your needs Tailor our product to suit your needs.</p>
      </div>

      <div className="text-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="#FFA726" className="w-8 mb-6 inline-block" viewBox="0 0 682.667 682.667">
          <defs>
      ...
      <div className="text-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="#FFA726" className="w-8 mb-6 inline-block" viewBox="0 0 512.001 512.001">
      ...
      <div className="text-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="#FFA726" className="w-8 mb-6 inline-block" viewBox="0 0 24 24">
      ...
      <div className="text-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="#FFA726" className="w-8 mb-6 inline-block" viewBox="0 0 504.69 504.69">
      ...
      <div className="text-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="#FFA726" className="w-8 mb-6 inline-block" viewBox="0 0 682.667 682.667">
          ...
          <g fill="none" stroke="#FFA726" strokeMiterlimit="10" strokeWidth="30" clipPath="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
